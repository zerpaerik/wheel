...
function drawCredits() {
  const player = getPlayer();
  fetchAvailableCredits({ player }).then(credits => {
...
async function registerOrLoginPlayer({ email }) {
...
async function fetchAvailableCredits({ player }) {
